...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHg6npk_Y8fPAzRLI1-2AUK9QDJohH5ow&callback=initialize&libraries=geometry,places" async defer></script>
<script>
  var map;
  var marker;
  function initialize() {
      ...
      google.maps.event.addListener(autocomplete, 'place_changed', function () {
          ...
          $('#location-text-box').val(place.formatted_address);
